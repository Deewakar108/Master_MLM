<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="First_joinng_Print_bill_GN.aspx.cs" Inherits="Master_MLM.Repurchase.First_joinng_Print_bill_GN" %>
    ...
    <div id="content" style="height: auto; text-align: justify; float: left; width: 100%; margin: 0px; padding: 0px;">
            ...
            <div style="margin: 0px auto 0px auto; height: auto; width: 730px;">
                ...
                <div style="margin: 0px 0px 18px 0px; height: auto; width: 730px; float: left;">
                    <div style="border-left: 1px solid #FF6600; border-right: 1px solid #FF6600; border-top: 1px solid #FF6600; margin: 0px; padding: 0px; width: 730px; height: auto; float: left;">
                        <div style="margin: 0px auto 0px auto; padding: 0px; width: 730px; height: auto; float: left;">
                            ...
                            <div style="width: 242px; float: left; margin: 0px; padding: 0px 0px 15px 0px;">
                                <h2 style="padding: 0px; margin: 0px 0px 5px 0px; float: left; width: 100%; font-family: arial, Helvetica, sans-serif; font-size: 12px; font-weight: bold; color: #003366; text-align: center; line-height: 20px;">
                                    <img src="../images/logo.png" style="margin: 0px 0px 5px 0px; width:100px" />
                                    <br />
                                    Imagine Grow Life</h2>
                                <%--<h2 style="padding: 0px; margin: 0px; float: left; width: 100%; font-family: arial, Helvetica, sans-serif; font-size: 12px; color: #333333; text-align: center; line-height: 20px;">Sanjiv Ranjan 
                                 Sristi Road No - 23 Sri Krishna Near Patna - 800001</h2>--%>
                    ...
                    <div style="margin: 0px; padding: 0px; width: 730px; height: auto; float: left; text-align: center;">
                        <asp:GridView ID="grdbill" runat="server" AutoGenerateColumns="False"
                            Width="732px" BorderColor="#FF6600" BorderStyle="Solid" BorderWidth="1px">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Tot Amount" ControlStyle-Width="130px">
                                    <ControlStyle Width="130"></ControlStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_TotSell_price" runat="server" Font-Names="Ebrima" Font-Size="12px" ForeColor="Maroon"
                                            Text='<%#Bind("Total_Mrp") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <div style="border-left: 1px solid #FF6600; border-right: 1px solid #FF6600; border-bottom: 1px solid #FF6600; margin: 0px auto; height: auto; width: 730px; float: left;">
                        ...
                        <div style="margin: 0px auto; height: auto; width: 730px; float: left;">
                            ...
                            <div style="border-left: 1px solid #FF6600; margin: 0px auto; padding: 0px; width: 237px; height: 53px; float: left; text-align: center;">
                                <div style="margin: 0px auto 0px auto; padding: 0px; width: 100%; height: 25px; float: left; text-align: center;  ">
                                   <%-- <div
                                        style="border-bottom: 1px solid #FF6600; margin: 0px auto; padding: 5px 0px 0px 5px; float: left; text-align: left; border-right: 1px solid #FF6600;"
                                        class="style2">
                                    ...
                                    <div style="border-bottom: 1px solid #FF6600; margin: 0px auto; padding: 5px 0px 0px 0px; float: left; text-align: center; color: #004488; font-family: ebrima; font-weight: bold; font-size: 10px;"
                                        class="style1">
                                ...
                                <div style="margin: 0px auto 0px auto; padding: 0px; width: 100%; height: 21px; float: left; text-align: center;">
                                    <div style="border-bottom: 1px solid #FF6600; margin: 0px auto; padding: 5px 0px 0px 5px; float: left; text-align: left; border-right: 1px solid #FF6600;"
                                        class="style2">
                                    ...
                                    <div style="border-bottom: 1px solid #FF6600; margin: 0px auto; padding: 5px 0px 0px 0px; float: left; text-align: center; color: #004488; font-family: ebrima; font-weight: bold; font-size: 0px;"
                                        class="style1">
