<%@ Page Title="" Language="C#" MasterPageFile="~/Repurchase/main.Master" AutoEventWireup="true" CodeBehind="Print_Stock.aspx.cs" Inherits="Master_MLM.Repurchase.Print_Stock" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="grid-form">
        <div class="grid-form1">
            <h4 class="breadcrumb-item"><a>Print Product List</a></h4>
            ...
            <div class="panel-body panel-footer">
                <div role="form" class="form-horizontal">
                    <div class="grd-over-flow" style="margin: 0px 0px 15px 0px">
                        ...
                        <asp:DropDownList ID="ddl_product_name" runat="server" class="form-control" Style="height: 36px; width: 152px; color: #222; float: left; margin: 0px 10px 0px 0px;">
                        </asp:DropDownList>
                    ...
                    <div class="grd-over-flow">
                        <asp:Panel ID="panel_view" runat="server" Visible="false">
                            <div id="tblPrintIQ" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; padding: 5px; margin: 0px; float: left; width: 1028px;">
                                ...
                                <asp:GridView ID="gridview" runat="server" Width="1028px" Style="margin: 10px 0px 0px 0px; float: left; padding: 0px; text-align: center; font-weight: normal;"
