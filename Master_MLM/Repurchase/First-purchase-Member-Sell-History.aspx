<%@ Page Title="" Language="C#" MasterPageFile="~/Repurchase/main.Master" AutoEventWireup="true" CodeBehind="First-purchase-Member-Sell-History.aspx.cs" Inherits="Master_MLM.Repurchase.First_purchase_Member_Sell_History" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Sell History Date Wise
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="grid-form">
        <div class="grid-form1">
            <h4 class="breadcrumb-item"><a>Sell History Date Wise</a></h4>
                            ...
                            <asp:GridView ID="gridview" runat="server"  Style="width:100%; margin: 10px 0px 0px 0px; float: left; padding: 0px; text-align: center; font-weight: normal;"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="View Details">
                                        <ItemTemplate>
                                            <a href="#" onclick='openWindow("<%# DataBinder.Eval(Container.DataItem,"Franchise_code")+"&Billno="+DataBinder.Eval(Container.DataItem,"Billno")+"&Membercode="+DataBinder.Eval(Container.DataItem,"Membercode")%>")'>
                                    ...
                                    <asp:TemplateField HeaderText="Bill No">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lbl_Franchise_code" runat="server" Text='<%#Bind("Franchise_code") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Total Price">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_Total_price" runat="server" Text='<%#Bind("Total_price") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        function openWindow(code) {
            window.open('first_purchase_popup_sell_history.aspx?Stockpoint_code=' + code, 'open_window', ' width=1100, height=480, left=0, top=0');
        }
    </script>
</asp:Content>
