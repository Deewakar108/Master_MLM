<%@ Page Title="" Language="C#" MasterPageFile="~/Repurchase/main.Master" AutoEventWireup="true" CodeBehind="Sell-Product-to-Member.aspx.cs" Inherits="Master_MLM.Repurchase.Sell_Product_to_Member" %>
                    ...
                    <asp:Panel ID="panel_member_details" runat="server" Visible="false">
                        <div class="grd-over-flow" style="margin: 40px 0px 0px 0px">
                            ...
                            <div class="textbx-box">
                                ...
                                <div class="textbx-wpr">
                                    <asp:DropDownList ID="ddl_product_name" runat="server" Style="height: 28px; width: 186px; padding: 0px;" AutoPostBack="true" OnSelectedIndexChanged="ddl_ddl_product_name_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="textbx-box">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <%--<asp:LinkButton ID="link_delete" runat="server" OnClick="link_delete_Click" OnClientClick='return confirm("Are you sure want to delete ?")' CausesValidation="true"><i class="grid-icon icon-trash"></i></asp:LinkButton>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
