<%@ Page Title="Topup Report" Language="C#" MasterPageFile="~/Member_4235profile/Member_main.Master" AutoEventWireup="true" CodeBehind="topup_report.aspx.cs"
    Inherits="Master_MLM.Member_4235profile.topup_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="grid-form">
        <div class="grid-form1">
            <h4 class="breadcrumb-item"><a>Topup Report</a></h4>
            <div class="panel-body panel-footer">
                <div class="row" style="padding: 3px 0px 0px 0px;">
                    <div class="ovrflow-div" style="margin: 0px auto 0px auto; padding: 30px 0px 30px 0px; height: auto;">
                        <div style="margin: 0px; padding: 0px; width: 100%; height: auto;">
                            <table border="0" style="margin: 25px auto 25px auto; background-color: White; border: 1px solid #eee287; height: 85px; display: none;"
                                class="round shadow">
