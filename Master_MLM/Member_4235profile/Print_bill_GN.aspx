<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_bill_GN.aspx.cs"
    Inherits="Master_MLM.Member_4235profile.Print_bill_GN" %>
                    ...
                    <div style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: 1px solid #000; margin: 0px; padding: 0px; width: 730px; height: auto; float: left;">
                        <div style="margin: 0px auto 0px auto; padding: 0px; width: 730px; height: auto; float: left;">
                            ...
                            <div style="width: 242px; float: left; margin: 0px; padding: 0px 0px 15px 0px;">
                                <h2 style="padding: 0px; margin: 0px 0px 5px 0px; float: left; width: 100%; font-family: arial, Helvetica, sans-serif; font-size: 15px; font-weight: bold; color: #003366; text-align: center; line-height: 20px;">
                                    <img src="../images/logo.png" style="margin: 0px 0px 5px 0px;" />
                                    Ocean Health Pariwar </h2>
                                ...
                                <h2 style="padding: 0px; margin: 0px; float: left; width: 100%; font-family: arial, Helvetica, sans-serif; font-size: 12px; color: #333333; text-align: center; line-height: 20px; text-decoration: underline;">(Repurchase Invoice)</h2>
                            </div>
                            <div style="width: 242px; float: left; margin: 0px; padding: 0px;">
                                <h2 style="padding: 0px 0px 0px 15px; margin: 0px 0px 5px 0px; float: left; width: 94%; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #003366; text-align: left; line-height: 20px;">
                    ...
                    <div style="margin: 0px; padding: 0px; width: 730px; height: auto; float: left; text-align: center;">
                        <asp:GridView ID="grdbill" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Cat & Desc" HeaderStyle-Width="210px">
                                    <ItemTemplate> 
                                        <asp:Label ID="lbl_description" runat="server" Font-Names="Ebrima" Font-Size="12px"
                                ...
                                <asp:TemplateField HeaderText="Tot BV" ControlStyle-Width="48px">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Tot_BV" runat="server" Font-Names="Ebrima" Font-Size="12px" ForeColor="Maroon"
                                            Width="50px" Text='<%#Bind("Tot_BV") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Tot Price" ControlStyle-Width="130px">
