<%@ Page Title="Total Carry Forward Amount" Language="C#" MasterPageFile="~/Member_4235profile/Member_main.Master" AutoEventWireup="true" 
    CodeBehind="total_carry_amount.aspx.cs" Inherits="Master_MLM.Member_4235profile.total_carry_amount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Home</a> <i class="fa fa-angle-right"></i><a href="#">Total Carry Forward Amount</a></li>
    </ol>


    <div class="grid-form">
        <div class="grid-form1">
            <h4 class="breadcrumb-item"><a>Total Carry Forward Amount</a></h4>
