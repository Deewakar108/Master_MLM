<%@ Page Title="Closing Pair Report" Language="C#" MasterPageFile="~/Member_4235profile/Member_main.Master" AutoEventWireup="true" CodeBehind="Repurchase_carry_forward_ClosingReport.aspx.cs" Inherits="Master_MLM.Member_4235profile.Repurchase_carry_forward_ClosingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#">Home</a> <i class="fa fa-angle-right"></i><a href="#">Repurchase Carry Forward Report</a></li>
    </ol>


    <div class="grid-form">
        <div class="grid-form1">
            <h4 class="breadcrumb-item"><a>Repurchase Carry Forward Report</a></h4>
