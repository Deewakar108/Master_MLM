<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="Verified_Genealogy_bt_two_date_positionwise.aspx.cs" Inherits="Master_MLM.Admin_87554b.Verified_Genealogy_bt_two_date_positionwise"
    Title="Genealogy" %>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Verified Member Genealogy</a>
            </div>
        </div>
            ...
            <div class="row-fluid">
                <div class="widget-box">
                    <div class="widget-title bg_lg">
                        ...
                        <h5>Verified Member Genealogy</h5>
                    </div>
                    <div class="widget-content">
                        ...
                        <div class="row-fluid">
                            <div class="span12" style="text-align: center;">
                                Member Code : 
                                <asp:TextBox ID="txt_memberid" runat="server" placeholder="Memeber Code" CssClass="span2"></asp:TextBox>
                            </div>
                            <div class="span12" style="text-align: center;">
                                Position :
                            ...
                            <asp:DropDownList ID="ddl_s_month" runat="server" CssClass="span1">
                                ...
                                &nbsp;
                            <asp:DropDownList ID="ddl_s_year" runat="server" CssClass="span1" Style="padding-left: 2px;">
                            </asp:DropDownList>
                            </div>
                            <div class="span12" style="text-align: center;">
                                To :
                            ...
                            <asp:DropDownList ID="ddl_e_month" runat="server" CssClass="span1">
                                ...
                                &nbsp;
                            <asp:DropDownList ID="ddl_e_year" runat="server" CssClass="span1" Style="padding-left: 2px;">
                            </asp:DropDownList>
                            </div>
                            <div class="span12" style="text-align: center;">
                        ...
                        <asp:Panel ID="panel_view_left_right_join" runat="server" Visible="false">
                            <div class="row-fluid" id="tblPrintIQ">
                                ...
                                <asp:GridView ID="grd_left" runat="server" CssClass="table table-bordered data-table dataTable"
                                    ...
                                    AllowSorting="True" OnSorting="grd_left_Sorting">
                                    <Columns>
                                ...
                                <div class="span12">
                                    ...
                                    <asp:Label ID="lbl_total_point" runat="server" CssClass="label label-warning"></asp:Label>
                                </div>
                            </div>
                        </asp:Panel>
                    </div>
