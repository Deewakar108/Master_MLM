<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="Binary_team_structure.aspx.cs" Inherits="Master_MLM.Admin.Binary_team_structure"
    Title=" View Tree" %>
                            ...
                            <div class="row-fluid">
                                ...
                                <asp:Panel ID="pnlAdmin" runat="server">
                                    ...
                                    <table style="width: 100%; margin: 0 auto; border: none;" id="Table2">
                                        <tbody>
                                            <tr>
                                                <td colspan="4" style="height: 23px;" class="align">
                                            ...
                                            <tr>
                                                <td colspan="4" class="align">
                                                    <img src="images/b-admin.gif" style="border-width: 0px;" />&nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="align" colspan="2">
                                                    <img src="images/b-Top2.gif" style="border-width: 0px;" /></td>
                                                <td class="align" colspan="2">
                                                    <img src="images/b-Top2.gif" style="border-width: 0px;" /></td>
                                            </tr>
                                            <tr>
                                                <td class="align level3">
