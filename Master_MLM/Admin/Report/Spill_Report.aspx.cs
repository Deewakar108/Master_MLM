    ...
    public partial class Spill_Report : System.Web.UI.Page
    {
        ...
        private void finddata()
        {
            if (rb_daily.Checked == true)
            {
                ...
                string queiry = "Select * from Member_registration where Date ='" + searchindate + "' and Member_code!='" + imp.AdminCode + "' and Referal_code=" + txt_memberid.Text + " and  Position ='" + ddl_position.Text + "' ORDER BY CONVERT(DATETIME, Date, 103)";
                bind_grid_view(queiry);
            }
            else if (rb_monthly.Checked == true)
            {
                string searchindate = ddl_month.Text + "/" + ddl_year.Text;
                string queiry = "Select * from Member_registration where Date Like '%" + searchindate + "' and Member_code!='" + imp.AdminCode + "' and Referal_code=" + txt_memberid.Text + " and  Position='" + ddl_position.Text + "' ORDER BY CONVERT(DATETIME, Date, 103)";
                bind_grid_view(queiry);
            }
