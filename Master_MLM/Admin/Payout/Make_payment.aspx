<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="Make_payment.aspx.cs" Inherits="Master_MLM.Admin_87554b.Make_payment"
    Title="Make Payment" EnableEventValidation="false" %>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Make Payment</a>
            </div>
        </div>
                            ...
                            <div class="row-fluid" id="tblPrintIQ" style="overflow-x:auto">
                                <asp:GridView ID="grd_payout_list" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered data-table dataTable">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <a href="#" class="btn btn-info" onclick="openWindow('<%#Eval("Membercode")+"&startdate="+Eval("Startdate")+"&enddate="+Eval("Enddate") %>');">View </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
