<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="Royalty_payout_chart.aspx.cs" Inherits="Master_MLM.Admin_87554b.Royalty_payout_chart"
    Title="Royalty Payout Chart" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
  Royalty Payout Chart
</asp:Content>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Royalty Payout Chart</a>
            </div>
        </div>
