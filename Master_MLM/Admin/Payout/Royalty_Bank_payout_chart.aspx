<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="Royalty_Bank_payout_chart.aspx.cs" Inherits="Master_MLM.Admin.Royalty_Bank_payout_chart"
    Title="Royalty Make Bank Payout" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Royalty  Make Bank Payout
</asp:Content>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Royalty >> Make Bank Payout Chart</a>
            </div>
        </div>
            ...
            <div class="row-fluid">
                <div class="widget-box">
                    <div class="widget-title bg_lg">
                        ...
                        <h5>Royalty >> Make Bank Payout Chart</h5>
                    </div>
