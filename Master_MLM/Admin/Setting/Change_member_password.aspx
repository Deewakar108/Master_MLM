<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master"
    AutoEventWireup="true" CodeBehind="Change_member_password.aspx.cs" Inherits="Master_MLM.Admin.Change_member_password"
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Change Member Password</a>
            </div>
        </div>
                            ...
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:Label ID="lbl_membercode" runat="server" ForeColor="Red" Font-Size="9pt" ></asp:Label>
                                     </div>
                                 </div>
                                <div class="control-group">
