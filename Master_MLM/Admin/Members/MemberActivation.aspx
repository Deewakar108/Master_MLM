<%@ Page Title="Member Activation" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="MemberActivation.aspx.cs"
    Inherits="Master_MLM.Admin_87554b.Members.MemberActivation" ValidateRequest="false" EnableEventValidation="false" %>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Member Activation</a>
            </div>
        </div>
            ...
            <div class="row-fluid">
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <asp:Button ID="btn_find" runat="server" Text="Show All Members" CssClass="btn btn-success" OnClick="btn_Submit_Click" />
                            </div>
                        ...
                        <asp:Panel ID="pnl_view" Visible="false" runat="server">
                            <div class="row-fluid">
                                <asp:GridView ID="grd_view" runat="server" CssClass="table table-bordered data-table dataTable"
                                    ...
                                    OnPageIndexChanging="grd_view_PageIndexChanging" OnRowDataBound="grd_view_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="btnTopUp" CssClass="btn btn-info" CommandArgument='<%#Bind("Member_code") %>' CommandName="IsActivate" runat="server" Text="Top-Up" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
