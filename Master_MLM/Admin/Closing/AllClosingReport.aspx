<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AllClosingReport.aspx.cs"
    Inherits="Master_MLM.Admin_87554b.AllClosingReport" %>
                                ...
                                <asp:GridView ID="grd_view" runat="server" CssClass="table table-bordered data-table dataTable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Closing No.">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClosingno" runat="server" Text='<%# Bind("Closingno") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Closing Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClosingDate" runat="server" Text='<%# Bind("Start_date") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
