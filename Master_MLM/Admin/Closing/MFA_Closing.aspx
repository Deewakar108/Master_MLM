<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="MFA_Closing.aspx.cs" Inherits="Master_MLM.Admin.Closing.MFA_Closing"
    Title="MFA Closing" %>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">MFA Closing</a>
            </div>
        </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content">
                        <div class="row-fluid">
                            ...
                            <div class="span12" style="text-align: center;">
                                <asp:Label ID="lblMessage" runat="server" Text="" CssClass="label label-warning"></asp:Label>
                            </div>
                        </div>
