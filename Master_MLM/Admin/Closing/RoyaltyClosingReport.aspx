<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RoyaltyClosingReport.aspx.cs"
    Inherits="Master_MLM.Admin_87554b.RoyaltyClosingReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Royalty Closing Report
</asp:Content>
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" class="current">Royalty Closing Report</a>
            </div>
        </div>
