<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="View_epin_daily_monthly_yearly.aspx.cs" Inherits="Master_MLM.Admin.View_epin_daily_monthly_yearly"
    Title="E-pin List" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row-fluid">
                <div class="widget-box">
                    <div class="widget-title bg_lg">
                        ...
                        <h5>E-PIN History Date Wise</h5>
                    </div>
                    <div class="widget-content">
                        <div class="row-fluid" style="text-align: center;">
                            <div class="span12">
                                <span>
                                    <asp:RadioButton ID="rb_daily" GroupName="g1" runat="server" AutoPostBack="True" OnCheckedChanged="rb_daily_CheckedChanged" />&nbsp;Daily</span>

                                <span style="padding: 0 10px 0 10px;">
                                    <asp:RadioButton ID="rb_monthly" GroupName="g1" runat="server" AutoPostBack="True" OnCheckedChanged="rb_monthly_CheckedChanged" />&nbsp;Monthly</span>

                                <span>
                                    <asp:RadioButton ID="rb_yearly" GroupName="g1" runat="server" AutoPostBack="True" OnCheckedChanged="rb_yearly_CheckedChanged" />&nbsp;Yearly</span>
                        ...
                        <div class="row-fluid" style="text-align: center;">
                            ...
                            <asp:DropDownList ID="ddl_year" runat="server" CssClass="span2" Style="max-width: 100px;">
                            </asp:DropDownList>
                            <br />
                            <asp:Button ID="btn_find" runat="server" Text="Find" CssClass="btn btn-primary"
                                OnClick="btn_Submit_Click" />
                            <br />
                            <asp:Label ID="lbl_message" runat="server" CssClass="label label-warning" ForeColor="Red"></asp:Label>
                        </div>
    ...
    <div class="row" style="display: none;">
        <div style="margin: 0px auto; padding: 0px; width: 100%; text-align: center;">
            <table style="margin: 25px auto 25px auto; background-color: White; border: 1px solid #666666; width: 535px; height: 85px;"
                class="round shadow">
                <tr>
                    <td colspan="2" height="30" style="padding: 10px 0px 10px 30px; text-align: left; font-family: arial, Helvetica, sans-serif; font-size: 18px; font-weight: bold;"
                        class=" blue_bg">E-PIN history date wise
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="padding: 10px 0px 10px 0px;">
                        <%--<asp:RadioButton ID="" runat="server" GroupName="g1" Text="Daily"  Style="margin: 0px 0px 0px 25px;" />
                        <asp:RadioButton ID="" runat="server" AutoPostBack="True" GroupName="g1"
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 5px 5px 5px 0px;" colspan="2"></td>
                </tr>
                <tr>
                    <td style="padding: 10px 0px 10px 0px; text-align: center;" colspan="4"></td>
                </tr>
                <tr>
                    <td style="padding: 0px 0px 10px 0px; text-align: center;" colspan="4"></td>
                </tr>
            </table>
        </div>
    </div>
    <div class="row" style="display: none;">
        <div style="margin: 0px auto; padding: 0px; width: 100%; text-align: center;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; padding: 0px; margin: 20px auto 20px auto; width: 1160px; font-family: arial, Helvetica, sans-serif; font-size: 15px; font-weight: bold; background-color: #FFFFFF; height: auto;"
                class="round shadow">
                <tr>
                                    ...
                                    <td colspan="2" height="30" style="padding: 5px 0px 5px 30px; text-align: left; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold;"
                                        ...
                                        <h2 style="text-align: center; width: 15%; margin: 0px; float: left;" class="noPrint">
                                            ...
                                            <asp:ImageButton ID="img_generated" runat="server" Height="32px" ImageUrl="~/images/Excelicons.png"
                                                Style="margin-left: 20px; width: 32px;" OnClick="img_generated_Click" />
                                        </h2>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" style="width: 100%; float: left">
                                <tr>
                                    <td colspan="2" height="30" style="padding: 5px 0px 5px 30px; text-align: left; color: #FFFFFF; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #CCCCCC;"
                                        class="blue_bg">
                                        <h2 style="text-align: left; width: 85%; margin: 0px; float: left;"></h2>
                                        <h2 style="text-align: center; width: 15%; margin: 0px; float: left;" class="noPrint">
