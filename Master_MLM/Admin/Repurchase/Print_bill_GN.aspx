<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_bill_GN.aspx.cs" Inherits="Master_MLM.Admin.Repurchase.Print_bill_GN" %>
                ...
                <div style="margin: 0px 0px 18px 0px; height: auto; width: 730px; float: left;">
                    <div style="border-left: 1px solid #000; border-right: 1px solid #000; border-top: 1px solid #000; margin: 0px; padding: 0px; width: 730px; height: auto; float: left;">
                        <div style="margin: 0px auto 0px auto; padding: 0px; width: 730px; height: auto; float: left;">
                            ...
                            <div style="width: 242px; float: left; margin: 0px; padding: 0px 0px 15px 0px; height: 95px;">
                                <h2 style="padding: 0px; margin: 0px 0px 5px 0px; float: left; width: 100%; font-family: arial, Helvetica, sans-serif; font-size: 12px; font-weight: bold; color: #003366; text-align: center; line-height: 20px;">
                                    <img src="../../images/logo.png" style="margin: 3px 0px 2px 0px; width: 100%;" />
                                    <br />
                                </h2>
                            ...
                            <div style="width: 242px; float: left; margin: 0px; padding: 0px;">
                                <h2 style="padding: 0px 0px 0px 15px; margin: 0px 0px 5px 0px; float: left; width: 94%; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #003366; text-align: right; line-height: 20px;">
                        ...
                        <div style="margin: 0px auto 0px auto; padding: 0px; width: 730px; height: auto; float: left; background-color: #fbfbfb;">
                            <div style="width: 100%; float: left; margin: 0px; padding: 0px;">
                                <h2 style="padding: 0px 0px 0px 15px; margin: 0px 0px 5px 0px; float: left; width: 97%; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #003366; text-align: left; line-height: 20px;">
                                    <asp:Label ID="label5" runat="server" Font-Bold="True" Font-Names="Ebrima" Font-Size="10pt" Text="Franchise Details" Style="text-decoration: underline; margin: 0px; padding: 0px 0px 5px 0px; text-align: justify;"></asp:Label>

                                </h2>
                                <h2 style="padding: 0px 0px 0px 15px; margin: 0px 0px 5px 0px; float: left; width: 30%; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #003366; text-align: left; line-height: 20px;">
                                ...
                                <h2 style="padding: 0px 0px 0px 15px; margin: 0px 0px 5px 0px; float: left; width: 40%; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #003366; text-align: left; line-height: 20px;">
                                ...
                                <h2 style="padding: 0px 0px 0px 15px; margin: 0px 0px 5px 0px; float: left; width: 23%; font-family: arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #003366; text-align: left; line-height: 20px;">
